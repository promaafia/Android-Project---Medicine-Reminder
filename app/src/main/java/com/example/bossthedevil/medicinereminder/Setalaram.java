...
public class Setalaram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setalaram);
        ...
        Intent alarmIntent = new Intent(Setalaram.this, AlarmReceiver.class);
        pendingIntent = PendingIntent.getBroadcast(Setalaram.this, ALARM_REQUEST_CODE, alarmIntent, 0);
    ...
    public void stopAlarmManager() {
        ...
        stopService(new Intent(Setalaram.this, AlarmSoundService.class));
    ...
    public void onBackPressed() {
        Intent alarmIntent = new Intent(Setalaram.this, MainMenu.class);
